...
from find_success import datatrans_2_end,datatrans_2_end_single_agent
import os
...
def run_script(file_path,skip_len):
    a = ["disk"]
    sample_info = datatrans_2_end_single_agent(process_dir=file_path,skip_len = skip_len)
...
if __name__ == "__main__":
    ...
    for i in range(0,num_gz):
        process_directory(os.path.join(base_directory,zip_files[i]),skip_len=skip_len)
    batch_size = 5
