...
from find_success import datatrans_2_end
import os
...
def run_script(file_path):
    a = ["disk"]
    sample_info = datatrans_2_end(process_dir=file_path)
