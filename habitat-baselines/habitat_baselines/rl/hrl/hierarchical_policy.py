...
class HierarchicalPolicy(nn.Module, Policy):
    ...
    def act(
        ...
        **kwargs,
        ...
        # print("should_inserts:",did_choose_new_skill.view(-1, 1),flush = True)
    ...
    def _update_skills(
        ...
        **kwargs,
        ...
        # the next skill.
        batch_size = masks.shape[0]
        # print("HLpolicy:",self._high_level_policy,flush = True)
        # print("config:",self.config.hierarchical_policy.high_level_policy,flush = True)
